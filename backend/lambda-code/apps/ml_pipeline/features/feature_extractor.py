...
class FeatureExtractor:
    ...
    FEATURE_GROUPS = {
        ...
        'ai_signals': [
            'home_injury_mention_score', 'away_injury_mention_score',
    ...
    def extract_match_features(
        ...
        Args:
            ...
            include_ai_signals: Whether to include the experimental
                LLM-derived news signal features (default off)
    ...
    def build_training_data(
        ...
        Args:
            ...
            include_ai_signals: Whether to include the experimental
                LLM-derived news signal features (default off — enable
                only to backtest whether it actually improves accuracy)
